...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span><a href="dashboard.php">home</a><i class="bx bx-right-arrow-alt"></i>update profile</span>
        </div>
    </div>
    <div class="line2"></div>
            ...
            <div class="flex">
                ...
                <div class="col">
                    <div class="input-field">
                        ...
                        <input type="password" name="old_pass" placeholder="Enter your password..." maxlength="50" required class="box">
                    </div>
                    <div class="input-field">
                        <p>New password <span>*</span></p>
                        <input type="password" name="new_pass" placeholder="Enter your password..." maxlength="50" required class="box">
                    </div>
                    <div class="input-field">
